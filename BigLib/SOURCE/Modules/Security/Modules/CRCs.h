...
namespace BigLib {
	namespace Crypts {
		namespace CRC {
			...
			typedef CRCEngine<uint8_t,		0x3,					true,	true,	0x0,					0x0,		4> CRC_4_G_704; // AKA CRC-4/ITU
			typedef CRCEngine<uint8_t,		0x3,					false,	false,	0xF,					0xF,		4> CRC_4_INTERLAKEN;

			typedef CRCEngine<uint8_t,		0x09,				false,	false,	0x09,				0x00,	5> CRC_5_EPC_C1G2; // AKA CRC-5/EPC
			typedef CRCEngine<uint8_t,		0x15,				true,	true,	0x00,				0x00,	5> CRC_5_G_704; // AKA CRC-5/ITU
			...
			typedef CRCEngine<uint8_t,		0x03,				true,	true,	0x00,				0x00,	6> CRC_6_G_704; // AKA CRC-6/ITU
			typedef CRCEngine<uint8_t,		0x2F,				false,	false,	0x00,				0x3F,	6> CRC_6_GSM;

			typedef CRCEngine<uint8_t,		0x09,				false,	false,	0x00,				0x00,	7> CRC_7_MMC; // AKA CRC-7
			...
			typedef CRCEngine<uint8_t,		0xA7,				true,	true,	0x00,				0x00> CRC_8_BLUETOOTH;
			typedef CRCEngine<uint8_t,		0x9B,				false,	false,	0xFF,				0x00> CRC_8_CDMA2000;
			typedef CRCEngine<uint8_t,		0x39,				true,	true,	0x00,				0x00> CRC_8_DARC;
			typedef CRCEngine<uint8_t,		0xD5,				false,	false,	0x00,				0x00> CRC_8_DVB_S2;
			...
			typedef CRCEngine<uint8_t,		0x1D,				false,	false,	0xFF,				0x00> CRC_8_HITAG;
			typedef CRCEngine<uint8_t,		0x07,				false,	false,	0x00,				0x55> CRC_8_I_432_1; // AKA CRC-8/ITU
			typedef CRCEngine<uint8_t,		0x1D,				false,	false,	0xFD,				0x00> CRC_8_I_CODE;
			typedef CRCEngine<uint8_t,		0x9B,				false,	false,	0x00,				0x00> CRC_8_LTE;
			typedef CRCEngine<uint8_t,		0x31,				true,	true,	0x00,				0x00> CRC_8_MAXIM_DOW; // AKA CRC-8/MAXIM, DOW-CRC
			typedef CRCEngine<uint8_t,		0x1D,				false,	false,	0xC7,				0x00> CRC_8_MIFARE_MAD;
			...
			typedef CRCEngine<uint8_t,		0x07,				false,	false,	0x00,				0x00> CRC_8_SMBUS; // AKA CRC-8
			typedef CRCEngine<uint8_t,		0x1D,				true,	true,	0xFF,				0x00> CRC_8_TECH_3250; // AKA CRC-8/AES, CRC-8/EBU
			typedef CRCEngine<uint8_t,		0x9B,				true,	true,	0x00,				0x00> CRC_8_WCDMA;
			
			typedef CRCEngine<uint16_t,	0x233,				false,	false,	0x000,				0x000,	10> CRC_10_ATM; // AKA CRC-10, CRC-10/I-610
			...
			typedef CRCEngine<uint16_t,	0x385,				false,	false,	0x01A,				0x000,	11> CRC_11_FLEXRAY; // AKA CRC-11
			...
			typedef CRCEngine<uint16_t,	0x80F,				false,	false,	0x000,				0x000,	12> CRC_12_DECT; // AKA X-CRC-12
			typedef CRCEngine<uint16_t,	0xD31,				false,	false,	0x000,				0xFFF,	12> CRC_12_GSM;
			typedef CRCEngine<uint16_t,	0x80F,				false,	true,	0x000,				0x000,	12> CRC_12_UMTS; // AKA CRC-12/3GPP
			...
			typedef CRCEngine<uint16_t,	0x8005,				true,	true,	0x0000,				0x0000> CRC_16_ARC; // AKA CRC-16, CRC-16/LHA, CRC-IBM
			...
			typedef CRCEngine<uint16_t,	0x1021,				false,	false,	0xFFFF,				0xFFFF> CRC_16_GENIBUS; // AKA CRC-16/DARC, CRC-16/EPC, CRC-16/EPC-C1G2, CRC-16/I-CODE
			...
			typedef CRCEngine<uint16_t,	0x8005,				true,	true,	0x0000,				0xFFFF> CRC_16_MAXIM_DOW; // AKA CRC-16/MAXIM
			...
			typedef CRCEngine<uint32_t,	0x864CFB,			false,	false,	0xB704CE,			0x000000,	24> CRC_24_OPENPGP; // AKA CRC-24
			...
			typedef CRCEngine<uint32_t,	0x814141AB,			false,	false,	0x00000000,			0x00000000> CRC_32_AIXM; // AKA CRC-32Q
			typedef CRCEngine<uint32_t,	0xF4ACFB13,			true,	true,	0xFFFFFFFF,			0xFFFFFFFF> CRC_32_AUTOSAR;
			typedef CRCEngine<uint32_t,	0xA833982B,			true,	true,	0xFFFFFFFF,			0xFFFFFFFF> CRC_32_BASE91_D; // AKA CRC-32D
			typedef CRCEngine<uint32_t,	0x04C11DB7,			false,	false,	0xFFFFFFFF,			0xFFFFFFFF> CRC_32_BZIP2; // AKA CRC-32/AAL5, CRC-32/DECT-B, B-CRC-32
			typedef CRCEngine<uint32_t,	0x8001801B,			true,	true,	0x00000000,			0x00000000> CRC_32_CD_ROM_EDC;
			typedef CRCEngine<uint32_t,	0x04C11DB7,			false,	false,	0x00000000,			0xFFFFFFFF> CRC_32_CKSUM; // AKA CRC-32/POSIX
			typedef CRCEngine<uint32_t,	0x1EDC6F41,			true,	true,	0xFFFFFFFF,			0xFFFFFFFF> CRC_32_ISCSI; // AKA CRC-32/BASE91-C, CRC-32/CASTAGNOLI, CRC-32/INTERLAKEN, CRC-32C
			typedef CRCEngine<uint32_t,	0x04C11DB7,			true,	true,	0xFFFFFFFF,			0xFFFFFFFF> CRC_32_ISO_HDLC; // AKA CRC-32, CRC-32/ADCCP, CRC-32/V-42, CRC-32/XZ, PKZIP
			...
			typedef CRCEngine<uint64_t,	0x42F0E1EBA9EA3693,	false,	false,	0x0000000000000000,	0x0000000000000000> CRC_64_ECMA_182; // CRC-64
			typedef CRCEngine<uint64_t,	0x000000000000001B,	true,	true,	0xFFFFFFFFFFFFFFFF,	0xFFFFFFFFFFFFFFFF> CRC_64_GO_ISO;
			typedef CRCEngine<uint64_t,	0x259C84CBA6426349,	true,	true,	0xFFFFFFFFFFFFFFFF,	0x0000000000000000> CRC_64_MS;
			typedef CRCEngine<uint64_t,	0xAD93D23594C935A9,	true,	true,	0x0000000000000000,	0x0000000000000000> CRC_64_REDIS;
			typedef CRCEngine<uint64_t,	0x42F0E1EBA9EA3693,	false,	false,	0xFFFFFFFFFFFFFFFF,	0xFFFFFFFFFFFFFFFF> CRC_64_WE;
			typedef CRCEngine<uint64_t,	0x42F0E1EBA9EA3693,	true,	true,	0xFFFFFFFFFFFFFFFF,	0xFFFFFFFFFFFFFFFF> CRC_64_XZ;
		}
	}
}